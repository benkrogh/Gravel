...
export function BottomNav() {
  ...
  return (
    <nav className="absolute inset-x-0 bottom-0 px-4 pb-[max(1.5rem,env(safe-area-inset-bottom,0px))]">
          ...
          {tabs.map(({ id, label, icon: IconComponent, notify }) => {
            ...
            return (
              <button
                ...
                className={`relative flex size-12 items-center justify-center rounded-2xl transition-all duration-200 ${
                  isActive
